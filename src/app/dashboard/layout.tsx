        ...
        <LayoutGroup>
          ...
          >
            <div className="flex flex-col h-full relative">
              <Link href="/dashboard" className="flex items-center p-3 pl-[6px] mb-8 mt-2">
                ...
                <AnimatePresence mode="wait">
                  {isSidebarOpen && (
                    <motion.span
                      ...
                      className="text-gradient font-bold font-sans text-[26px] tracking-wide whitespace-nowrap overflow-hidden ml-4"
                    >
                      AIden
                    </motion.span>
                  )}
                ...
                >
                  ...
                  >
                    <path
                      ...
                      d={
                        !isSidebarOpen
                          ? 'M13 19l7-7-7-7M5 19l7-7-7-7' // When closed, show >> (pointing right)
                          : 'M11 19l-7-7 7-7m8 14l-7-7 7-7' // When open, show << (pointing left)
                      }
                    />
                  </svg>
                </button>
